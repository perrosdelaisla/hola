...
### Otros
- **[index.html](index.html)** · estructura del splash + chat + input fijo. Importa `./victoria.js?v=43` (la query `?v=` se incrementa para invalidar caché en clientes).
