...
### Otros
- **[index.html](index.html)** · estructura del splash + chat + input fijo. Importa `./victoria.js?v=71` (la query `?v=` se incrementa para invalidar caché en clientes).
...
- `index.html` → carga `victoria.js?v=71`
- `victoria.js` → importa `agenda.js?v=71`, `supabase.js?v=71`, etc.
